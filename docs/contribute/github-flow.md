...
<!-- Title: Contributing GithubFlow TerraformGithubProject -->
...
To contribute to terraform-github-project project on [GitHub](https://github.com/hadenlabs/terraform-github-project), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/terraform-github-project/pulls).
...
To follow the instructions in this guide and start contributing to terraform-github-project project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/terraform-github-project.git
```

Now your **upstream** points to **hadenlabs/terraform-github-project**.
...
git fetch upstream # assuming upstream is hadenlabs/terraform-github-project
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/terraform-github-project/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
